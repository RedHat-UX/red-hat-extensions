...
import RHDSPlugin from '#11ty-plugins/rhx.js';
...
export default async function(eleventyConfig: UserConfig) {
  ...
  await eleventyConfig.addPlugin(RHDSPlugin, {
    ...
    componentModules: [
      'node_modules/@rhds/elements/elements/rh-button/rh-button.js',
      'node_modules/@rhds/elements/elements/rh-icon/rh-icon.js',
      'node_modules/@rhds/elements/elements/rh-surface/rh-surface.js',
      'node_modules/@rhds/elements/elements/rh-code-block/rh-code-block.js',
      'node_modules/@rhds/elements/elements/rh-table/rh-table.js',
      'node_modules/@rhds/elements/elements/rh-accordion/rh-accordion.js',
      'node_modules/@rhds/elements/elements/rh-cta/rh-cta.js',
      'node_modules/@rhds/elements/elements/rh-footer/rh-footer-universal.js',
      'node_modules/@rhds/elements/elements/rh-skip-link/rh-skip-link.js',
      'node_modules/@rhds/elements/elements/rh-subnav/rh-subnav.js',
      'node_modules/@rhds/elements/elements/rh-tag/rh-tag.js',
